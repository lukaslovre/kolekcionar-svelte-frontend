...
<div class="relative mb-4 h-48 w-full">
	...
	<div class="absolute inset-x-4 top-4 flex items-center justify-between">
		{#each topButtonHandlers as { onclick }}
			<button
				type="button"
				class="flex h-10 w-10 items-center justify-center rounded bg-black/75 transition-colors hover:bg-black/90"
				{onclick}
			>
	...
	<div class="absolute inset-x-4 bottom-4 flex items-center justify-center gap-3">
		<div
			class="flex h-8 items-center justify-center gap-1 rounded bg-black/75 px-4 transition-colors hover:bg-black/90"
		>
